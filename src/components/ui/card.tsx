...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-2xl border-t bg-white/50 p-(--card-spacing)",
        className
      )}
      {...props}
    />
